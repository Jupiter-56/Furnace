                ...
                if (args.length == 0) {
                    ...
                    if(args.length == 1){
                        ...
                        if(arg.equalsIgnoreCase("version")){
                            ...
                            p.sendMessage(Main.getConfiguration().getString("prefix") + " " + Main.getConfiguration().getString("messages.version") + " " + "§l1.0.0" + " " + "§r§a!");
                        ...
                        if(arg.equalsIgnoreCase("panel")){
                            ...
                            meta2.setLore(Arrays.asList("§a§lVersion : §r§f1.0", "§9§lAuthor : §r§fJupiDev - Jupiter_56"));
